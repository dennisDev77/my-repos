...
const Anual = () => {
  return (
    <section className='pt-12 '>
      ...
      <div className='p-2 bg-color-black rounded-md flex flex-wrap flex-col items-center justify-center gap-2 transition md:hover:scale-105 shadow shadow-color-red' key={anual.id}>
        <div><img src={anual.img} alt="Carregando o card" className='md:w-56 w-full rounded-md' /></div>
    ...
    <div className='flex flex-wrap items-center justify-center pt-3'>
      <Link className='text-gray-400 text-base font-light text-center' to='anual'>Ver Tudo</Link>
    </div>
    </section>
  )
}
