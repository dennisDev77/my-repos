...
const Mensal = () => {
 ...
 <div className='flex flex-wrap justify-center gap-5 items-center px-10 md:px-0'>

    {
        PlanosMensal.map((mensal)=>(
      
      <div className='p-2 bg-color-black rounded-md flex flex-wrap flex-col items-center justify-center gap-2 transition md:hover:scale-105 shadow shadow-color-red' key={mensal.id}>
        <div><img src={mensal.img} alt="Carregando o card" className='md:w-56 w-full rounded-md ' /></div>
    ...
    <div className='flex flex-wrap items-center justify-center pt-3'>
      ...
      <Link className='text-gray-400 text-base font-light text-center' to='mensal'>Ver Tudo</Link>
    </div>
    </section>
  )
}
